...
# Credentials are set as provided by Kimathi Joram (celestakim018@gmail.com), GIS & RS enthusiast at DeKUT.
RASTER_DB_CONFIG = {
    "host": "localhost",
    "dbname": "DEM",
    "user": "postgres",
...
# Helper functions to establish connections to the raster and vector databases.
...
# Helper function to assign a default color to each table based on its name
...
@app.route("/")
def index():
    # Renders the main HTML template for the frontend
    return render_template("index3.html")

# Retrieves a list of all spatial tables
...
# Provides a PNG image preview of a specific raster tile
...
def raster_preview(table, rid):
    try:
        ...
        # Get summary stats for reclassification
        cur.execute(f"""
...
# Downloads a specific raster tile as a GeoTIFF
...
# Retrieves a layer's data as GeoJSON
...
# Retrieves a layer's attribute data
...
# Downloads selected vector features as zipped GeoJSON
...
# Downloads entire layer as zipped GeoJSON
...
# Merges selected features with shared boundaries
...
# Merges selected features from multiple layers
...
# Creates a new layer from selected features
